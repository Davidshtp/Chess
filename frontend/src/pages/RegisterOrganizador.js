...
function RegisterOrganizador() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Registrar organizador (crea usuario + organizador)
      await api.post('/organizadores/registrar', {
        nombre_organizador: formData.nombre_organizador,
    ...
    <div className="h-screen flex overflow-hidden bg-white">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <h2 className="text-5xl font-bold mb-4 drop-shadow-lg leading-tight">Crea y Organiza Torneos</h2>
          <p className="text-lg max-w-sm opacity-95 leading-relaxed drop-shadow-md">
            Gestiona torneos profesionales y administra jugadores
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900">Registro Organizador</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {/* Nombre Organizador */}
            <div>
              <label htmlFor="nombre_organizador" className="block text-xs font-semibold text-gray-700 mb-1">
